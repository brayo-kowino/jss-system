...
const CACHE_VERSION = "eeskia-v3.7.4";
...
self.addEventListener("fetch", (event) => {
  ...
  if (!url.pathname.startsWith("/app/") && !url.pathname.startsWith("/assets/") && !url.pathname.startsWith("/fonts/") && url.pathname !== "/site.webmanifest") {
    return;
  }
